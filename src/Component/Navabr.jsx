// Updated Navbar.js with working filters for Movies, TV Shows, Language, Genre, and New (Latest by year)
...
function Navbar({ setData }) {
    ...
    const FilterByCategory = (type) => {
        ...
        setData(filtered); // This sets the filtered result to App.jsx
    ...
    return (
        <div>
            <div
                className={`flex items-center justify-between fixed w-full z-50 transition-colors duration-300 ${
